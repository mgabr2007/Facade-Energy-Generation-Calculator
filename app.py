...
module_name = st.selectbox("Select PV Module", available_modules, index=available_modules.index('Canadian_Solar_CS5P_220M__2009_') if 'Canadian_Solar_CS5P_220M__2009_' in available_modules else 0, help="Select the PV module from the available list.")
